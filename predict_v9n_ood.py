"""v9n + Mahalanobis OOD 탐지 적용 - 20개 메시지 분류"""
import sys, os
...
header = f"{'#':>2}  {'정답':^3}  {'기본예측':^4}  {'OOD보정':^5}  {'거리':>7}  {'OOD?':^5}  {'기본OK':^4}  {'보정OK':^4}  메시지"
lines.append(header)
lines.append("─" * 120)
...
with open("predict_ood_results.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))
print("done")
